...
public class PlayerView {//Esta clase es la que se va a enviar a java script
	...
	List<Integer> sumCardPlayers = new ArrayList<Integer>();	//int[][] numHandPlayers; //El tamaño del array es la cantidad de jugador que hay, y el array en la posicion i es la cantidad de cartas que tiene en la mano el jugador i
